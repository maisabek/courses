...
export class HomeComponent implements OnInit {
  ...
  info:any[]=[
     {id:1,title:"Introduction to website creation and remote work",
     content:"you will receive fundamental knowledge and put it into practice by creating your first website. You will be provided .",list:["Setting goals for the course","Remote work rules. Personal motivation and its development","Web developer tools. Services to help you work","Basic concepts. Types of sites"],img:"assets/images/25.png"},
     {id:2,title:"Basics of UX/UI web design",
     content:"set your personal goals, get a boost of motivation, learn to work with information and how to organize your work, how to plan work and rest.",list:["System installation for website creation","Basic site setup. Header and footer","Creation of the first pages of the site","30 lessons on creating your own website"],img:"assets/images/21.png"},
